  ...
  return (
    <section>
      <main className="w-full min-h-screen flex">
        <div className=" w-[600px] bg-white py-7">
        ...
        {/* ---- RIGHT SIDE ---- */}
        <div className="flex-1 bg-[#FBFAFC] p-9">
          ...
          <div className="w-full bg-white shadow-lg p-6 text-sm">
            ...
            <div className="w-[550px] mx-auto mt-16">
              <img
                className="w-full h-full object-cover rounded-[4px]"
            ...
            <footer className="bg-[#FBFAFC] w-full py-5 text-[#312F33] mt-16">
              ...
              <div className="w-[450px] text-center mx-auto mt-8">
                <p>The ROI Team</p>
                <p className="my-3">
