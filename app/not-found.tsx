...
export default function NotFound() {
  return (
    ...
    //       <h1 className="text-9xl tracking-tighter-less text-shadow font-sans font-bold">
    //         <span>4</span>
    //         <span>0</span>
    //         <span>4</span>
    //       </h1>
    ...
    // </div>
    <div
      className="flex items-center justify-center min-h-screen bg-primaryPurple bg-fixed bg-cover bg-bottom"
      style={{
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
            <div className="relative">
              <h1 className="relative text-9xl tracking-tighter-less font-sans font-bold">
                <span>4</span>
                <span>0</span>
                <span>4</span>
              </h1>
            ...
            <Link
              href="/"
              className=" ring-white ring-2 hover:bg-white hover:text-primaryPurple bg-primaryPurple px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg"
            >
              Go to Home
            </Link>
          </div>
